...
OPENAI_BASE_URL = "https://api.fullstackllm.com"
...
async def get_code(user_prompt, user_openai_key=None, model="gpt-3.5-turbo-0613"):
    ...
    Notes: 
        First, think step by step what you want to do and write it down Chinese.
        Then generate valid Python code in a code block and add Chinese Comments.
        ...
        Be sure to generate charts with matplotlib and must set fonts use'from matplotlib.font_manager import FontProperties
        font_prop = FontProperties(fname='/usr/local/SimHei.ttf')' first line. If you need geographical charts, use geopandas with the geopandas.datasets module.
...
def upload_file():
    ...
    if file and allowed_file(file.filename):
        ...
        return jsonify({'message': f'file {file.filename} 上传成功.\n{file_info}'}), 200
    else:
